...
class UtopiaRequest(BaseModel):
    ...
    solution: list[float] = Field(
        description="The solution for which the map is generated."
    )
...
def utopia(  # noqa: C901, PLR0912
    ...
    archived_solutions = read_solutions_from_db(
        db, request.problem_id, user.index, method_id
    )
    ...
    for key in decision_variables:
        ...
        try:
            treatments = utopia_data.schedule_dict[key][
            ...
            print(e)
        treatments_dict[key] = {
            utopia_data.years[0]: 0,
            utopia_data.years[1]: 0,
            utopia_data.years[2]: 0,
        }
    ...
    for year in utopia_data.years:
        ...
        for key in decision_variables:
            ...
            if utopia_data.stand_descriptor:
                name = (
                    utopia_data.stand_descriptor[str(stand)]
