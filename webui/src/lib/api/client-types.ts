...
export interface paths {
    ...
    "/method/rpm/solve": {
        ...
        /**
         * Solve Solutions
         * @description Solve the problem using the RPM method.
         */
    ...
    "/method/rpm/save": {
         ...
         */
        post: operations["save_method_rpm_save_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/method/rpm/get-or-initialize": {
         ...
         */
        post: operations["get_or_initialize_method_rpm_get_or_initialize_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/method/rpm/initialize": {
        ...
        /**
         * Initialize
         * @description Initialize the problem for the RPM method.
         */
        post: operations["initialize_method_rpm_initialize_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/method/rximo/explain": {
        ...
        /**
         * Explain Rximo
         * @description Explain the RXIMO method using SHAP values.
         *
         ...
         */
        post: operations["explain_rximo_method_rximo_explain_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
         ...
         * @description Model of the request to the RPM method.
         */
        RPMInitializationRequest: {
            /** Problem Id */
            problem_id: number;
        ...
        /**
         * RPMSolveResponse
         * @description The response from the RPM solve endpoint.
         */
        RPMSolveResponse: {
            /**
             * State Id
        ...
        /**
         * RXIMOExplainRequest
         * @description Model of the request to the RXIMO explainer.
         */
        RXIMOExplainRequest: {
            /** Problem Id */
            problem_id: number;
         ...
         * @description The response from the RXIMO explain endpoint.
         */
        RXIMOExplainResponse: {
            /**
             * Shap Values
...
export interface operations {
    ...
    solve_solutions_method_rpm_solve_post: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RPMSolveResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    save_method_rpm_save_post: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["RPMSaveRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RPMSaveResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    get_or_initialize_method_rpm_get_or_initialize_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["RPMInitializationRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RPMInitializationResponse"] | components["schemas"]["RPMSolveResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    initialize_method_rpm_initialize_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RPMInitializationResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    explain_rximo_method_rximo_explain_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["RXIMOExplainRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RXIMOExplainResponse"];
                };
            };
            /** @description Validation Error */
            422: {
