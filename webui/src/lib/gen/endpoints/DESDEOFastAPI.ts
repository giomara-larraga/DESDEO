...
export type CalculateScoreBandsMethodScoreBandsMethodSolvePostParams = {
	problem_id?: number | null;
};
...
export type calculateScoreBandsMethodScoreBandsMethodSolvePostResponse422 = {
	data: HTTPValidationError;
	status: 422;
};

export type calculateScoreBandsMethodScoreBandsMethodSolvePostResponseSuccess =
	calculateScoreBandsMethodScoreBandsMethodSolvePostResponse200 & {
		headers: Headers;
	};
export type calculateScoreBandsMethodScoreBandsMethodSolvePostResponseError =
	calculateScoreBandsMethodScoreBandsMethodSolvePostResponse422 & {
		headers: Headers;
	};

export type calculateScoreBandsMethodScoreBandsMethodSolvePostResponse =
	| calculateScoreBandsMethodScoreBandsMethodSolvePostResponseSuccess
	| calculateScoreBandsMethodScoreBandsMethodSolvePostResponseError;

export const getCalculateScoreBandsMethodScoreBandsMethodSolvePostUrl = (
...
export const calculateScoreBandsMethodScoreBandsMethodSolvePost = async (
	...
	return customFetch<calculateScoreBandsMethodScoreBandsMethodSolvePostResponse>(
		getCalculateScoreBandsMethodScoreBandsMethodSolvePostUrl(params),
		{
			...options,
			method: 'POST',
			headers: { 'Content-Type': 'application/json', ...options?.headers },
