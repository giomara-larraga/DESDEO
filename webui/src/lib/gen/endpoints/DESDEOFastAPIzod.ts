...
export const getProblemsInfoProblemAllInfoGetResponseObjectivesItemObjectiveTypeDefault = `analytical`;
				...
				zod
					.object({
						...
						variable_type: zod
							...
							.describe('Type of the variable. Can be real, integer or binary.'),
						lowerbound: zod
			...
			zod
				.object({
					...
					objective_type: zod
						...
						.default(getProblemsInfoProblemAllInfoGetResponseObjectivesItemObjectiveTypeDefault)
						.describe(
...
export const GetProblemProblemProblemIdGetQueryParams = zod.object({
...
export const getProblemProblemProblemIdGetResponseObjectivesItemObjectiveTypeDefault = `analytical`;
		...
		objectives: zod.array(
			zod
				.object({
					...
					objective_type: zod
						.enum(['analytical', 'data_based', 'simulator', 'surrogate'])
						.default(getProblemProblemProblemIdGetResponseObjectivesItemObjectiveTypeDefault)
						.describe(
							"The type of objective function. 'analytical' means the objective function value is calculated based on 'func'. 'data_based' means the objective function value should be retrieved from a table. In case of 'data_based' objective function, the 'func' field is ignored. Defaults to 'analytical'."
						),
					is_linear: zod
...
export const DeleteProblemProblemProblemIdDeleteQueryParams = zod.object({
	session_id: zod.union([zod.number(), zod.null()]).optional()
});
...
export const addProblemProblemAddPostResponseObjectivesItemObjectiveTypeDefault = `analytical`;
		...
		objectives: zod.array(
			zod
				.object({
					...
					objective_type: zod
						.enum(['analytical', 'data_based', 'simulator', 'surrogate'])
						.default(addProblemProblemAddPostResponseObjectivesItemObjectiveTypeDefault)
						.describe(
							"The type of objective function. 'analytical' means the objective function value is calculated based on 'func'. 'data_based' means the objective function value should be retrieved from a table. In case of 'data_based' objective function, the 'func' field is ignored. Defaults to 'analytical'."
						),
					is_linear: zod
...
export const addProblemJsonProblemAddJsonPostResponseObjectivesItemObjectiveTypeDefault = `analytical`;
		...
		objectives: zod.array(
			zod
				.object({
					...
					objective_type: zod
						.enum(['analytical', 'data_based', 'simulator', 'surrogate'])
						.default(addProblemJsonProblemAddJsonPostResponseObjectivesItemObjectiveTypeDefault)
						.describe(
							"The type of objective function. 'analytical' means the objective function value is calculated based on 'func'. 'data_based' means the objective function value should be retrieved from a table. In case of 'data_based' objective function, the 'func' field is ignored. Defaults to 'analytical'."
						),
					is_linear: zod
...
export const GetAllRepresentativeSolutionSetsProblemProblemIdAllRepresentativeSolutionSetsGetQueryParams =
	zod.object({
		session_id: zod.union([zod.number(), zod.null()]).optional()
	});
...
export const GetProblemJsonProblemProblemIdJsonGetQueryParams = zod.object({
	session_id: zod.union([zod.number(), zod.null()]).optional()
});
 ...
 */
export const GetMultipliersInfoMethodNimbusGetMultipliersInfoPostQueryParams = zod.object({
	problem_id: zod.union([zod.number(), zod.null()]).optional()
});

export const GetMultipliersInfoMethodNimbusGetMultipliersInfoPostBody = zod
	.object({
		state_id: zod.number(),
		objective_symbols: zod.union([zod.array(zod.string()), zod.null()]).optional()
	})
	.describe('Request to get Lagrange multipliers from the solutions in a state.');

export const GetMultipliersInfoMethodNimbusGetMultipliersInfoPostResponse = zod
	.object({
		lagrange_multipliers: zod
			.union([
				zod.array(zod.union([zod.record(zod.string(), zod.number()), zod.null()])),
				zod.null()
			])
			.describe('List of Lagrange multipliers for each solution, or None if not available'),
		tradeoffs_matrix: zod
			.union([
				zod.array(
					zod.union([zod.record(zod.string(), zod.record(zod.string(), zod.number())), zod.null()])
				),
				zod.null()
			])
			.optional()
			.describe('List of tradeoffs matrices for each solution, or None if not available'),
		active_objectives: zod
			.union([zod.array(zod.array(zod.string())), zod.null()])
			.optional()
			.describe('List of active objectives for each solution, or None if not available')
	})
 ...
 * @summary Solve Solutions
 */
export const SolveSolutionsMethodXnimbusSolvePostQueryParams = zod.object({
	problem_id: zod.union([zod.number(), zod.null()]).optional()
});

export const solveSolutionsMethodXnimbusSolvePostBodyPreferencePreferenceTypeDefault = `reference_point`;
export const solveSolutionsMethodXnimbusSolvePostBodyNumDesiredDefault = 1;

export const SolveSolutionsMethodXnimbusSolvePostBody = zod
	.object({
		problem_id: zod.number(),
		session_id: zod.union([zod.number(), zod.null()]).optional(),
		parent_state_id: zod.union([zod.number(), zod.null()]).optional(),
		...
		preference: zod
			.object({
				preference_type: zod
					.literal('reference_point')
					.default(solveSolutionsMethodXnimbusSolvePostBodyPreferencePreferenceTypeDefault),
				aspiration_levels: zod.record(zod.string(), zod.number())
			})
			.optional()
			.describe('Model for representing a reference point type of preference.'),
		...
		num_desired: zod
			.union([zod.number(), zod.null()])
			.default(solveSolutionsMethodXnimbusSolvePostBodyNumDesiredDefault)
	})
	.describe('Model of the request to the nimbus method.');

export const solveSolutionsMethodXnimbusSolvePostResponseResponseTypeDefault = `nimbus.classification`;
export const solveSolutionsMethodXnimbusSolvePostResponsePreviousPreferencePreferenceTypeDefault = `reference_point`;

export const SolveSolutionsMethodXnimbusSolvePostResponse = zod
	.object({
		response_type: zod
			.literal('nimbus.classification')
			.default(solveSolutionsMethodXnimbusSolvePostResponseResponseTypeDefault),
		state_id: zod.union([zod.number(), zod.null()]).describe('The newly created state id'),
		previous_preference: zod
			.object({
				preference_type: zod
					.literal('reference_point')
					.default(
						solveSolutionsMethodXnimbusSolvePostResponsePreviousPreferencePreferenceTypeDefault
					),
				aspiration_levels: zod.record(zod.string(), zod.number())
			})
			.describe('The previous preference used.'),
 ...
 * @summary Initialize
 */
export const InitializeMethodXnimbusInitializePostQueryParams = zod.object({
	problem_id: zod.union([zod.number(), zod.null()]).optional()
});

export const initializeMethodXnimbusInitializePostBodyStartingPointOnePreferenceTypeDefault = `reference_point`;

export const InitializeMethodXnimbusInitializePostBody = zod
	.object({
		problem_id: zod.number(),
		session_id: zod.union([zod.number(), zod.null()]).optional(),
		parent_state_id: zod.union([zod.number(), zod.null()]).optional(),
				...
				zod
					.object({
						preference_type: zod
							.literal('reference_point')
							.default(
								initializeMethodXnimbusInitializePostBodyStartingPointOnePreferenceTypeDefault
							),
						aspiration_levels: zod.record(zod.string(), zod.number())
					})
					.describe('Model for representing a reference point type of preference.'),
...
export const initializeMethodXnimbusInitializePostResponseResponseTypeDefault = `nimbus.initialization`;

export const InitializeMethodXnimbusInitializePostResponse = zod
	.object({
		response_type: zod
			.literal('nimbus.initialization')
			.default(initializeMethodXnimbusInitializePostResponseResponseTypeDefault),
		state_id: zod.union([zod.number(), zod.null()]).describe('The newly created state id'),
		current_solutions: zod
			.array(
				zod
 ...
 * @summary Save
 */
export const SaveMethodXnimbusSavePostQueryParams = zod.object({
	problem_id: zod.union([zod.number(), zod.null()]).optional()
});

export const SaveMethodXnimbusSavePostBody = zod
	.object({
		problem_id: zod.number(),
		session_id: zod.union([zod.number(), zod.null()]).optional(),
		parent_state_id: zod.union([zod.number(), zod.null()]).optional(),
...
export const saveMethodXnimbusSavePostResponseResponseTypeDefault = `nimbus.save`;

export const SaveMethodXnimbusSavePostResponse = zod
	.object({
		response_type: zod
			.literal('nimbus.save')
			.default(saveMethodXnimbusSavePostResponseResponseTypeDefault),
		state_id: zod.union([zod.number(), zod.null()]).describe('The id of the newest state')
	})
	.describe('The response from NIMBUS save endpoint.');
 ...
 */
export const SolveXnimbusIntermediateMethodXnimbusIntermediatePostQueryParams = zod.object({
	problem_id: zod.union([zod.number(), zod.null()]).optional()
});

export const solveXnimbusIntermediateMethodXnimbusIntermediatePostBodyNumDesiredDefault = 1;

export const SolveXnimbusIntermediateMethodXnimbusIntermediatePostBody = zod
	.object({
		problem_id: zod.number(),
		session_id: zod.union([zod.number(), zod.null()]).optional(),
		parent_state_id: zod.union([zod.number(), zod.null()]).optional(),
		...
		num_desired: zod
			.union([zod.number(), zod.null()])
			.default(solveXnimbusIntermediateMethodXnimbusIntermediatePostBodyNumDesiredDefault),
		reference_solution_1: zod
			.object({
				state_id: zod.number().describe('State of the desired solution.'),
				solution_index: zod.number().describe('Index of the desired solution.'),
...
export const solveXnimbusIntermediateMethodXnimbusIntermediatePostResponseResponseTypeDefault = `nimbus.intermediate`;

export const SolveXnimbusIntermediateMethodXnimbusIntermediatePostResponse = zod
	.object({
		response_type: zod
			.literal('nimbus.intermediate')
			.default(solveXnimbusIntermediateMethodXnimbusIntermediatePostResponseResponseTypeDefault),
		state_id: zod.union([zod.number(), zod.null()]).describe('The newly created state id'),
		reference_solution_1: zod
			.record(zod.string(), zod.number())
			.describe('The first solution used when computing intermediate points.'),
 ...
 * @summary Get Or Initialize
 */
export const GetOrInitializeMethodXnimbusGetOrInitializePostQueryParams = zod.object({
	problem_id: zod.union([zod.number(), zod.null()]).optional()
});

export const getOrInitializeMethodXnimbusGetOrInitializePostBodyStartingPointOnePreferenceTypeDefault = `reference_point`;

export const GetOrInitializeMethodXnimbusGetOrInitializePostBody = zod
	.object({
		problem_id: zod.number(),
		session_id: zod.union([zod.number(), zod.null()]).optional(),
		parent_state_id: zod.union([zod.number(), zod.null()]).optional(),
				...
				zod
					.object({
						preference_type: zod
							.literal('reference_point')
							.default(
								getOrInitializeMethodXnimbusGetOrInitializePostBodyStartingPointOnePreferenceTypeDefault
							),
						aspiration_levels: zod.record(zod.string(), zod.number())
					})
					.describe('Model for representing a reference point type of preference.'),
...
export const getOrInitializeMethodXnimbusGetOrInitializePostResponseOneResponseTypeDefault = `nimbus.initialization`;
export const getOrInitializeMethodXnimbusGetOrInitializePostResponseTwoResponseTypeDefault = `nimbus.classification`;
export const getOrInitializeMethodXnimbusGetOrInitializePostResponseTwoPreviousPreferencePreferenceTypeDefault = `reference_point`;
export const getOrInitializeMethodXnimbusGetOrInitializePostResponseThreeResponseTypeDefault = `nimbus.intermediate`;
export const getOrInitializeMethodXnimbusGetOrInitializePostResponseFourResponseTypeDefault = `nimbus.finalize`;

export const GetOrInitializeMethodXnimbusGetOrInitializePostResponse = zod.union([
	zod
		.object({
			response_type: zod
				.literal('nimbus.initialization')
				.default(getOrInitializeMethodXnimbusGetOrInitializePostResponseOneResponseTypeDefault),
			state_id: zod.union([zod.number(), zod.null()]).describe('The newly created state id'),
			current_solutions: zod
				.array(
					zod
	...
	zod
		.object({
			response_type: zod
				.literal('nimbus.classification')
				.default(getOrInitializeMethodXnimbusGetOrInitializePostResponseTwoResponseTypeDefault),
			state_id: zod.union([zod.number(), zod.null()]).describe('The newly created state id'),
			previous_preference: zod
				.object({
					preference_type: zod
						.literal('reference_point')
						.default(
							getOrInitializeMethodXnimbusGetOrInitializePostResponseTwoPreviousPreferencePreferenceTypeDefault
						),
					aspiration_levels: zod.record(zod.string(), zod.number())
				})
				.describe('The previous preference used.'),
	...
	zod
		.object({
			response_type: zod
				.literal('nimbus.intermediate')
				.default(getOrInitializeMethodXnimbusGetOrInitializePostResponseThreeResponseTypeDefault),
			state_id: zod.union([zod.number(), zod.null()]).describe('The newly created state id'),
			reference_solution_1: zod
				.record(zod.string(), zod.number())
				.describe('The first solution used when computing intermediate points.'),
	...
	zod
		.object({
			response_type: zod
				.literal('nimbus.finalize')
				.default(getOrInitializeMethodXnimbusGetOrInitializePostResponseFourResponseTypeDefault),
			state_id: zod.union([zod.number(), zod.null()]).describe('The newly created state id'),
			final_solution: zod
				.object({
					name: zod.union([zod.string(), zod.null()]).optional(),
 ...
 */
export const FinalizeXnimbusMethodXnimbusFinalizePostQueryParams = zod.object({
	problem_id: zod.union([zod.number(), zod.null()]).optional()
});

export const FinalizeXnimbusMethodXnimbusFinalizePostBody = zod
	.object({
		problem_id: zod.number(),
		session_id: zod.union([zod.number(), zod.null()]).optional(),
		parent_state_id: zod.union([zod.number(), zod.null()]).optional(),
...
export const finalizeXnimbusMethodXnimbusFinalizePostResponseResponseTypeDefault = `nimbus.finalize`;

export const FinalizeXnimbusMethodXnimbusFinalizePostResponse = zod
	.object({
		response_type: zod
			.literal('nimbus.finalize')
			.default(finalizeXnimbusMethodXnimbusFinalizePostResponseResponseTypeDefault),
		state_id: zod.union([zod.number(), zod.null()]).describe('The newly created state id'),
		final_solution: zod
			.object({
				name: zod.union([zod.string(), zod.null()]).optional(),
 ...
 * @summary Delete Save
 */
export const DeleteSaveMethodXnimbusDeleteSavePostQueryParams = zod.object({
	problem_id: zod.union([zod.number(), zod.null()]).optional()
});

export const DeleteSaveMethodXnimbusDeleteSavePostBody = zod
	.object({
		state_id: zod.number().describe('The ID of the save state.'),
		solution_index: zod.number().describe('The ID of the solution within the above state.'),
		problem_id: zod.number().describe('The ID of the problem.')
...
export const deleteSaveMethodXnimbusDeleteSavePostResponseResponseTypeDefault = `nimbus.delete_save`;

export const DeleteSaveMethodXnimbusDeleteSavePostResponse = zod
	.object({
		response_type: zod
			.string()
			.default(deleteSaveMethodXnimbusDeleteSavePostResponseResponseTypeDefault),
		message: zod.union([zod.string(), zod.null()]).optional()
	})
	.describe('Response of NIMBUS save deletion.');
 ...
 * @summary Get Multipliers Info
 */
export const GetMultipliersInfoMethodXnimbusGetMultipliersInfoPostQueryParams = zod.object({
	problem_id: zod.union([zod.number(), zod.null()]).optional()
});

export const GetMultipliersInfoMethodXnimbusGetMultipliersInfoPostBody = zod
	.object({
		state_id: zod.number(),
		objective_symbols: zod.union([zod.array(zod.string()), zod.null()]).optional()
	})
...
export const GetMultipliersInfoMethodXnimbusGetMultipliersInfoPostResponse = zod
	.object({
		lagrange_multipliers: zod
			.union([
				zod.array(zod.union([zod.record(zod.string(), zod.number()), zod.null()])),
...
export const ModifyProblemMethodCumulusModifyProblemPostResponse = zod
	.object({
		...
		scenario_model_id: zod
			.union([zod.number(), zod.null()])
			.optional()
			.describe('DB id of the ScenarioModelDB associated with the original problem, if any.'),
		is_ready: zod
			.boolean()
...
export const SolveIntermediateMethodGenericIntermediatePostResponse = zod
	.object({
		...
		reference_solution_1: zod
			...
			.describe('The first solution used when computing intermediate solutions.'),
		reference_solution_2: zod
			.object({
				name: zod.union([zod.string(), zod.null()]).optional(),
				solution_index: zod.union([zod.number(), zod.null()]),
			...
			.describe('The second solution used when computing intermediate solutions.'),
...
export const GetUtopiaDataUtopiaPostBody = zod
	.object({
		...
		solution: zod
			...
			.describe('Solution for which to generate the map')
	})
...
export const GetStateMethodEnautilusGetStateStateIdGetResponse = zod
	.object({
		request: zod
			...
			.describe('The original request for generating the state.'),
		response: zod
			.object({
				state_id: zod
					.union([zod.number(), zod.null()])
			...
			.describe('The state generated by the request.')
	})
...
export const GetSessionTreeMethodEnautilusSessionTreeSessionIdGetParams = zod.object({
	session_id: zod.union([zod.number(), zod.null()])
});
				...
				zod
					.object({
						...
						result: zod
								...
								options: zod
									.object({
										...
										distance_formula: zod
											.union([zod.literal(1), zod.literal(2)])
											.default(
												getOrInitializeGdmScoreBandsGetOrInitializePostResponseHistoryItemOneResultOptionsDistanceFormulaDefault
											)
											.describe(
												'Distance formula to use. The value should be 1 or 2. Check the paper for details. Defaults to 1.'
											),
							...
							.describe('The results of the score bands procedure.')
					})
 ...
 * @summary Initialize Or Get Score Bands Method
 */
export const InitializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostQueryParams =
	zod.object({
		problem_id: zod.union([zod.number(), zod.null()]).optional()
	});

export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmOneNameDefault = `GMM`;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmOneScoringMethodDefault = `silhouette`;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmTwoNameDefault = `DBSCAN`;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmThreeNameDefault = `KMeans`;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmThreeNClustersDefault = 5;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmFourNameDefault = `DimensionCluster`;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmFourNClustersDefault = 5;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmFourKindDefault = `EqualWidth`;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmFiveNameDefault = `Custom`;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmDefault =
	{ name: 'DBSCAN' };
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsDistanceFormulaDefault = 1;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsDistanceParameterDefault = 0.05;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsUseAbsoluteCorrelationsDefault = false;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsIncludeSolutionsDefault = false;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsIncludeMediansDefault = false;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsIntervalSizeDefault = 0.95;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyOptimizationOptionsOptimizeDefault = false;

export const InitializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBody = zod
	.object({
		problem_id: zod.number(),
		session_id: zod.union([zod.number(), zod.null()]).optional(),
		parent_state_id: zod.union([zod.number(), zod.null()]).optional(),
		scorebands_options: zod
			.object({
				...
				clustering_algorithm: zod
						...
						zod
							.object({
								name: zod
									.string()
									.default(
										initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmOneNameDefault
									)
									.describe('Gaussian Mixture Model clustering algorithm.'),
								scoring_method: zod
									.enum(['BIC', 'silhouette'])
									.default(
										initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmOneScoringMethodDefault
									)
									.describe(
										'Scoring method to use for GMM. Either \"BIC\" or \"silhouette\". Defaults to \"silhouette\".\nThis option determines how the number of clusters is chosen.'
									)
						...
						zod
							.object({
								name: zod
									.string()
									.default(
										initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmTwoNameDefault
									)
									.describe('DBSCAN clustering algorithm.')
							})
							.describe('Options for DBSCAN clustering algorithm.'),
						zod
							.object({
								name: zod
									.string()
									.default(
										initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmThreeNameDefault
									)
									.describe('KMeans clustering algorithm.'),
								n_clusters: zod
									.number()
									.default(
										initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmThreeNClustersDefault
									)
									.describe('Number of clusters to use. Defaults to 5.')
							})
							.describe('Options for KMeans clustering algorithm.'),
						zod
							.object({
								name: zod
									.string()
									.default(
										initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmFourNameDefault
									)
									.describe('Clustering by one of the dimensions.'),
								dimension_name: zod.string().describe('Dimension to use for clustering.'),
								n_clusters: zod
									.number()
									.default(
										initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmFourNClustersDefault
									)
									.describe('Number of clusters to use. Defaults to 5.'),
								kind: zod
									.enum(['EqualWidth', 'EqualFrequency'])
									.default(
										initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmFourKindDefault
									)
									.describe(
										'Kind of clustering to use. Either \"EqualWidth\", which divides the dimension range into equal width intervals,\nor \"EqualFrequency\", which divides the dimension values into intervals with equal number of solutions.\nDefaults to \"EqualWidth\".'
									)
						...
						zod
							.object({
								name: zod
									.string()
									.default(
										initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmFiveNameDefault
									)
									.describe('Custom user-provided clusters.'),
								clusters: zod
									.array(zod.number())
					...
					.default(
						initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsClusteringAlgorithmDefault
					)
					.describe('Clustering algorithm to use. Currently supports one of `ClusteringOptions`.'),
				distance_formula: zod
					.union([zod.literal(1), zod.literal(2)])
					.default(
						initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsDistanceFormulaDefault
					)
					.describe(
						'Distance formula to use. The value should be 1 or 2. Check the paper for details. Defaults to 1.'
					),
				distance_parameter: zod
					.number()
					.default(
						initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsDistanceParameterDefault
					)
					.describe(
						'Change the relative distances between the objective axes. Increase this value if objectives are placed too close\ntogether. Decrease this value if the objectives are equidistant in a problem with objective clusters. Defaults\nto 0.05.'
					),
				use_absolute_correlations: zod
					.boolean()
					.default(
						initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsUseAbsoluteCorrelationsDefault
					)
					.describe(
						'Whether to use absolute value of the correlation to calculate the placement of axes. Defaults to False.'
					),
				include_solutions: zod
					.boolean()
					.default(
						initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsIncludeSolutionsDefault
					)
					.describe(
						'Whether to include individual solutions. Defaults to False. If True, the size of the resulting figure may be\nvery large for datasets with many solutions. Moreover, the individual traces are hidden by default, but can be\nviewed interactively in the figure.'
					),
				include_medians: zod
					.boolean()
					.default(
						initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsIncludeMediansDefault
					)
					.describe(
						'Whether to include cluster medians. Defaults to False. If True, the median traces are hidden by default, but\ncan be viewed interactively in the figure.'
					),
				interval_size: zod
					.number()
					.default(
						initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyScorebandsOptionsIntervalSizeDefault
					)
					.describe(
						'The size (as a fraction) of the interval to use for the bands. Defaults to 0.95, meaning that 95% of the\nmiddle solutions in a cluster will be included in the band. The rest will be considered outliers.'
					),
			...
			.optional()
			.describe('Configuration options for SCORE bands visualization.'),
		optimization_options: zod
			.object({
				optimize: zod
					.boolean()
					.default(
						initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostBodyOptimizationOptionsOptimizeDefault
					)
					.describe('Indicates if SCORE bands will perform optimization or not.'),
				algorithm: zod
					.union([zod.enum(['nsga3', 'rvea']), zod.null()])
					.optional()
					.describe(
						'The optimization algorithm to use. If not provided, the default algorithm will be used.'
					),
				algorithm_options: zod
					.union([zod.record(zod.string(), zod.unknown()), zod.null()])
					.optional()
					.describe(
						'Additional options for the optimization algorithm. This can be used to specify parameters such as population size, number of generations, etc.'
					)
			})
			.optional()
			.describe('Options to indicate if SCORE bands will perform optimization or not.')
	})
	.describe('Calculate and persist SCORE Bands for a discrete problem.');

export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmOneNameDefault = `GMM`;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmOneScoringMethodDefault = `silhouette`;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmTwoNameDefault = `DBSCAN`;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmThreeNameDefault = `KMeans`;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmThreeNClustersDefault = 5;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmFourNameDefault = `DimensionCluster`;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmFourNClustersDefault = 5;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmFourKindDefault = `EqualWidth`;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmFiveNameDefault = `Custom`;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmDefault =
	{ name: 'DBSCAN' };
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsDistanceFormulaDefault = 1;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsDistanceParameterDefault = 0.05;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsUseAbsoluteCorrelationsDefault = false;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsIncludeSolutionsDefault = false;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsIncludeMediansDefault = false;
export const initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsIntervalSizeDefault = 0.95;

export const InitializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponse = zod
	.object({
		state_id: zod.number(),
		result: zod
			.object({
				options: zod
					.object({
						...
						clustering_algorithm: zod
								...
								zod
									.object({
										name: zod
											.string()
											.default(
												initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmOneNameDefault
											)
											.describe('Gaussian Mixture Model clustering algorithm.'),
										scoring_method: zod
											.enum(['BIC', 'silhouette'])
											.default(
												initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmOneScoringMethodDefault
											)
											.describe(
												'Scoring method to use for GMM. Either \"BIC\" or \"silhouette\". Defaults to \"silhouette\".\nThis option determines how the number of clusters is chosen.'
											)
								...
								zod
									.object({
										name: zod
											.string()
											.default(
												initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmTwoNameDefault
											)
											.describe('DBSCAN clustering algorithm.')
									})
									.describe('Options for DBSCAN clustering algorithm.'),
								zod
									.object({
										name: zod
											.string()
											.default(
												initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmThreeNameDefault
											)
											.describe('KMeans clustering algorithm.'),
										n_clusters: zod
											.number()
											.default(
												initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmThreeNClustersDefault
											)
											.describe('Number of clusters to use. Defaults to 5.')
									})
									.describe('Options for KMeans clustering algorithm.'),
								zod
									.object({
										name: zod
											.string()
											.default(
												initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmFourNameDefault
											)
											.describe('Clustering by one of the dimensions.'),
										dimension_name: zod.string().describe('Dimension to use for clustering.'),
										n_clusters: zod
											.number()
											.default(
												initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmFourNClustersDefault
											)
											.describe('Number of clusters to use. Defaults to 5.'),
										kind: zod
											.enum(['EqualWidth', 'EqualFrequency'])
											.default(
												initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmFourKindDefault
											)
											.describe(
												'Kind of clustering to use. Either \"EqualWidth\", which divides the dimension range into equal width intervals,\nor \"EqualFrequency\", which divides the dimension values into intervals with equal number of solutions.\nDefaults to \"EqualWidth\".'
											)
								...
								zod
									.object({
										name: zod
											.string()
											.default(
												initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmFiveNameDefault
											)
											.describe('Custom user-provided clusters.'),
										clusters: zod
											.array(zod.number())
							...
							.default(
								initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsClusteringAlgorithmDefault
							)
							.describe(
								'Clustering algorithm to use. Currently supports one of `ClusteringOptions`.'
							),
						distance_formula: zod
							.union([zod.literal(1), zod.literal(2)])
							.default(
								initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsDistanceFormulaDefault
							)
							.describe(
								'Distance formula to use. The value should be 1 or 2. Check the paper for details. Defaults to 1.'
							),
						distance_parameter: zod
							.number()
							.default(
								initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsDistanceParameterDefault
							)
							.describe(
								'Change the relative distances between the objective axes. Increase this value if objectives are placed too close\ntogether. Decrease this value if the objectives are equidistant in a problem with objective clusters. Defaults\nto 0.05.'
							),
						use_absolute_correlations: zod
							.boolean()
							.default(
								initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsUseAbsoluteCorrelationsDefault
							)
							.describe(
								'Whether to use absolute value of the correlation to calculate the placement of axes. Defaults to False.'
							),
						include_solutions: zod
							.boolean()
							.default(
								initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsIncludeSolutionsDefault
							)
							.describe(
								'Whether to include individual solutions. Defaults to False. If True, the size of the resulting figure may be\nvery large for datasets with many solutions. Moreover, the individual traces are hidden by default, but can be\nviewed interactively in the figure.'
							),
						include_medians: zod
							.boolean()
							.default(
								initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsIncludeMediansDefault
							)
							.describe(
								'Whether to include cluster medians. Defaults to False. If True, the median traces are hidden by default, but\ncan be viewed interactively in the figure.'
							),
						interval_size: zod
							.number()
							.default(
								initializeOrGetScoreBandsMethodMethodScoreBandsMethodInitializePostResponseResultOptionsIntervalSizeDefault
							)
							.describe(
								'The size (as a fraction) of the interval to use for the bands. Defaults to 0.95, meaning that 95% of the\nmiddle solutions in a cluster will be included in the band. The rest will be considered outliers.'
							),
